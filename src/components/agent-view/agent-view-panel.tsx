      ...
      <AnimatePresence>
        {showFloatingToggle ? (
          ...
          >
            ...
            <span className="absolute right-0 top-0 inline-flex size-4 items-center justify-center rounded-full bg-primary-950 text-[10px] font-medium leading-none text-primary-50 tabular-nums">
              {activeCount}
            </span>
          </motion.button>
        ) : null}
