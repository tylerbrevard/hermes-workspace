              ...
              <div className="grid grid-cols-2 gap-2">
                {quickStartTemplates.map((tpl) => (
                  <button
                    ...
                    className={cn(
                      'flex items-center gap-2 rounded-xl border-2 px-3 py-3 text-left transition-[color,background-color,border-color,box-shadow,opacity,transform,width,height,max-height]',
