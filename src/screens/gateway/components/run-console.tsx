...
// eslint-disable-next-line no-control-regex -- Intentional control-char scrubber for command previews.
const CONTROL_CHAR_RE = new RegExp('[\\u0000-\\u001F\\u007F]', 'gu')
...
function sanitizeArgsPreview(args?: string): string {
  ...
  const cleaned = args.replace(CONTROL_CHAR_RE, ' ').replace(/\s+/g, ' ').trim()
