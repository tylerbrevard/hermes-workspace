                        ...
                        <div className="flex flex-wrap items-start gap-2">
                          ...
                          >
                            <button
                              ...
                              aria-label={`Workspace context: ${workspaceButtonLabel}`}
                            >
                              <svg
                                width="13"
                                height="13"
                              ...
                              <div className="absolute bottom-full left-0 z-[200] mb-2 min-w-[16rem] overflow-hidden rounded-xl border border-neutral-200 bg-white p-1 shadow-xl animate-in fade-in slide-in-from-bottom-2 duration-150 dark:border-neutral-700 dark:bg-neutral-900">
                                ...
                                {workspaceEntries.length === 0 ? (
                                  <div className="px-3 py-2 text-xs text-neutral-500">
                                    No workspace roots found
                                  </div>
                                ) : null}
                                <button
                                  type="button"
                                  onClick={handleOpenWorkspaceManager}
                                  className="mt-1 flex w-full items-center rounded-lg px-3 py-2 text-left text-xs font-medium text-accent-600 transition-colors hover:bg-accent-50 dark:text-accent-300 dark:hover:bg-accent-950/30"
                                >
                                  Open file explorer
                                </button>
                              </div>
