...
2. Research best 2026 AI game stack, dispatched to the researcher lane.
3. Dispatch parallel lanes:
   - builder: mobile UX repair
   - strategist: gameplay systems architecture
   - ops-watch: easter egg/prize boundary
   - reviewer: integration/security review
