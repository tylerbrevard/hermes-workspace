...
NEXT_ACTION: Wait for km-agent NEEDS_REVIEW checkpoint, then dispatch reviewer byte-verified review.
```
...
```text
/swarm-specs/projects/km-agent.md
```
